...
ui <- fluidPage(
  ...
  tags$style(HTML("
    .nav li a[data-value='oferta'] { display: none !important; }
  ")), #para que a oferta não carregue assim que inicar o programa
...
server <- function(input, output) {
  ...
  output$tabela5 <- renderDT({
    ...
    #hide(selector = 'a[data-value="oferta"]')
